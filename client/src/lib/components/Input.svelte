...
<div class="pt-8 {tw}">
    <div bind:this={mainRef}
        ...
        <slot name="left" />
        <label for={id} class="z-0 {isFocused ? 'absolute -translate-y-9 -translate-x-2.5' : 'whitespace-nowrap relative'} text-white/50 transition duration-150">{placeholder}</label>
