...
<div class={twMerge('group bg-white/[.01] border border-white/10 hover:border-white/[.15] bg-gradient-neutral p-4 rounded-3xl relative transition duration-300 overflow-hidden backdrop-blur-xl', noAnim ? '' : '', tw)}>
