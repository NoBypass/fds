...
<ResponsiveContainer>
    <nav class="grid grid-rows-none grid-cols-6 w-full h-20">
        ...
        <div class="flex items-center col-span-2">
            <div bind:this={inputRef} class="w-full border transition-all duration-200 border-neutral-300 py-1 px-4 rounded-full hover:border-neutral-400 flex gap-2 items-center">
        ...
        <div class="flex col-start-6 items-center gap-12 justify-self-end">
            <ul class="flex gap-4">
                {#each links as link}
